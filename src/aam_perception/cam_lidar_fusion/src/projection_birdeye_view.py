...
class projection():
    ...
    def projection_pipeline(self):
        ...
        mask_yellow = cv2.inRange(outputY,(0,0,0),(0,255,255) )
        ...
        mask_blue = cv2.inRange(output,(0,0,0),(255,0,0) )
        ...
        mask_orange = cv2.inRange(output,(0,0,0),(0,125,255) )
        ...
        for j in self.points:
            ...
            for pixU , pixV in zip(yellow_pix[0] , yellow_pix[1]):
                ...
                if ((pixU-px) < 50) & ((pixV-py)<50) & ((pixU-px) > -50) & ((pixV-py) > -50):
            ...
            for pixU , pixV in zip(blue_pix[0] , blue_pix[1]):
                ...
                if ((pixU-px) < 100) & ((pixV-py)<100) & ((pixU-px) > -100) & ((pixV-py) > -100):
            ...
            for pixU , pixV in zip(orange_pix[0] , orange_pix[1]):
                ...
                if ((pixU-px) < 50) & ((pixV-py)<50) & ((pixU-px) > -5) & ((pixV-py) > -50):
